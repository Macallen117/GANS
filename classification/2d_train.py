...
from meter import *
from dataset import *
from classification.LSTM.LSTM_models import *
...
class Trainer:
    def __init__(self, net, lr, batch_size, num_epochs):
        ...
        self.dataloaders = {
            phase: get_imagedataloader(phase, batch_size) for phase in self.phases
        }
    ...
    def run(self):
        for epoch in range(self.num_epochs):
            ...
            if val_loss < self.best_loss:
                ...
                print('\nNew checkpoint\n')
                self.best_loss = val_loss
                torch.save(self.net.state_dict(), f"ResNet/net/best_model_epoc{epoch}.pth")
...
if __name__ == '__main__':
    ...
    # start train
    trainer = Trainer(net=model, lr=1e-3, batch_size=10, num_epochs=300)
    trainer.run()  
