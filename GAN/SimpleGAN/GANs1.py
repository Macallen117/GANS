...
#a random batch of images from our true datasetaa, generating a set of images from our
...
#and true datasetaa and set its output to a parameter called valid, which will indicate
